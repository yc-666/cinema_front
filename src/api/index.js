...
export const getCardData = query=>{
    return request({
        url:"members/"+query.memberId+"/cards",
        method:'get',
        params:query
    });
};
...
export const registerCard = query=>{
    return request({
        url:"members/"+query.memberId+"/cards/reg",
        method:'post',
        params:query
    });
};
...
export const reissueCard = query=>{
    return request({
        url:"members/"+query.memberId+"/cards/reissue/"+query.cardId,
        method:'post',
        params:query
    });
};
...
export const cancelCard = query=>{
    return request({
        url:"members/"+query.memberId+"/cards/cancel/"+query.cardId,
        method:'put',
        params:query
    });
};
...
export const loseCard = query=>{
    return request({
        url:"members/"+query.memberId+"/cards/lose/"+query.cardId,
        method:'put',
        params:query
    });
};
...
export const rechargeCard = query=>{
    return request({
        url:"members/"+query.memberId+"/cards/"+query.cardId+"/recharge",
        method:'post',
...
export const consumeCard = query=>{
    return request({
        url:"members/"+query.memberId+"/cards/"+query.cardId+"/consume",
        method:'post',
        data:qs.stringify(query)
    });
};
...
export const exchangeIntegral = query=>{
    return request({
        url:"members/"+query.memberId+"/cards/integral/exchange",
        method:'post',
        data:qs.stringify(query)
    });
};
...
export const getCardIdByFuzzyQuery = query=>{
    return request({
        url:"members/"+query.memberId+"/cards/"+query.cardId+"/like",
        method:'get',
        params:query
    });
};
...
export const getCardByCardId = query=>{
    return request({
        url:"members/"+query.memberId+"/cards/"+query.cardId,
        method:'get',
        params:query
    });
};
